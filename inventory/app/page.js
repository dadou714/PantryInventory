    ...
    >
      ...
      <Box border={'1px solid #333'}>
        <Box
          ...
          alignItems={'center'}
        >
          <Typography variant={'h4'} color={'#333'} fontFamily={'Segoe UI Symbol'} textAlign={'center'}>
            Inventory Items
          </Typography>
        </Box>
...
<TableContainer component={Paper} sx={{ width: '800px', minHeight: '300px', overflow: 'auto' }}>
      <Table>
        <TableHead>
          <TableRow>
